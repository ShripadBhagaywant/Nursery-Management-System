<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserNs.Master" AutoEventWireup="true" CodeBehind="Indoor.aspx.cs" Inherits="project_Nusery.user.Indoor" %>
                                ...
                                <div class="box">
                                    <div>
                                        ...
                                        <div class="detail-box">
                                            ...
                                            <div class="options">
                                                <h6>₹<%# Eval("Price") %>  </h6>
                                                <asp:LinkButton runat="server" ID="lbAddToCart" CommandArgument="addToCart"
                                                    CommandArguments=' <%# Eval("ProductId") %> '>
