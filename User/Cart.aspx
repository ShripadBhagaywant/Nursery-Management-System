<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserNs.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="project_Nusery.user.Cart" %>
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Indoor.aspx" class="btn btn-info"><i class="fa fa-arrow-circle-left mr-2"></i>Continue Purchase</a>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbUpdateCart" runat="server" CommandArgument="updateCart" CssClass="btn btn-warning">
                                <i class="fa fa-refresh mr-2"></i>Update Cart
                            </asp:LinkButton>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbcheckout" runat="server" CommandArgument="checkout" CssClass="btn btn-success">
