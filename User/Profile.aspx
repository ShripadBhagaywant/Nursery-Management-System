<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserNs.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="project_Nusery.user.Profile" %>
                                    ...
                                    <div class="col-12">
                                        <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" style="margin-top:9px;">
                                                <a class="nav-item text-info" id="connectedServices-tab" data-toggle="tab" href="#connectedServices"
                                                    role="tab" aria-controls="connectedServices" aria-selected="false"><i class="fa-solid fa-clock"></i> Purchased History</a>
                                            </li>
                                        </ul>
                         <%--Basic User Info Navbar end--%>
